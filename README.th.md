...
- **เชื่อมต่อง่าย** — ค้นหา harness บน Wi-Fi ให้อัตโนมัติ (สแกนซับเน็ตแบบแอ็กทีฟ +
  ...
  และมีสวิตช์เชื่อมต่ออัตโนมัติ (ตัวที่ใช้ล่าสุด / LAN / เครื่องนี้)
- **รันบนโทรศัพท์เครื่องเดียวกันได้** — เมื่อ harness อยู่ใน Termux โหมด **เครื่องนี้** จะเริ่มและหยุดมัน
  ลงชื่อเข้าใช้จากบรรทัดเริ่มต้นที่มันพิมพ์ออกมา และติดตั้งอัปเดตของแอปผ่าน Termux
...
- สำหรับโหมด **เครื่องนี้**: [Termux](https://github.com/termux/termux-app) 0.118 ขึ้นไป
  (บิลด์จาก F-Droid หรือ GitHub) พร้อม Node.js 22.19+ ดู [`harness/TERMUX.md`](harness/TERMUX.md)
...
2. เปิดแอปแล้วเลือกวิธีเชื่อมต่อ ทั้งหมดนี้ไม่ใช่ตัวเลือกย่อยของการตั้งค่าเดียวกัน —
   ให้เลือกอันที่ตรงกับว่า harness รันอยู่ที่ไหน

   **เครื่องนี้** — harness รันอยู่ใน Termux บนโทรศัพท์เครื่องนี้เอง ไม่ต้องแพตช์ ไม่ต้องรีเลย์
   และไม่มีอะไรออกจากเครื่อง ใน Termux:
   ...
   จากนั้นในแอป: **เครื่องนี้ → เริ่ม harness** แล้วอนุญาตสิทธิ์ Termux ที่ Android ถาม แอปจะรัน
   `dsh web` อ่านลิงก์เริ่มต้นที่มันพิมพ์ออกมา ลงชื่อเข้าใช้เอง แล้วเชื่อมต่อ harness ที่คุณรันเอง
   (`dsh web --no-open`) ก็ถูกพบเช่นกัน: วางลิงก์เริ่มต้นของมันหนึ่งครั้งเมื่อการ์ดขึ้นว่า
   **ลงชื่อเข้าใช้** โหมดนี้ยังใช้กับ harness บนคอมพิวเตอร์ที่ส่งต่อผ่าน USB ด้วย
   `adb reverse tcp:3080 tcp:3080` รายละเอียด การอัปเดตผ่าน Termux หรือ SSH และการแก้ปัญหา:
